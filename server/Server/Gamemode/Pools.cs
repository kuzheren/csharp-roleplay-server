...
namespace ProtonServer
{
    public partial class Gamemode
    {
        ...
        private Dictionary<int, object[]> staticDialogInfo = new Dictionary<int, object[]>()
        {
            ...
            { 1, new object[] { "Добро пожаловать!", DialogType.INFO, "Добро пожаловать! Вы зашли на RP. Для получения справки отправьте команду /help в чат." } },
            ...
            { 118, new object[] { "Смена музыки", DialogType.INPUT, "Введите имя файла музыки (пример: rp.mp3)" } },

            { 131, new object[] { "Приветствие", DialogType.INFO, "Добро пожаловать в лучшую игру 2023 века - Симулятор РП!" } },
        ...
        private static Dictionary<string, string> questInfo = new Dictionary<string, string>
        {
            ...
            { "В поисках зондби", "4000$;Где-то на карте есть зондби. Тебе нужно найти его, чтобы пройти квест." }
        };
        ...
        private List<string> helpResponses = new List<string>
        {
            ...
            "устройся летчиком-бомбардировщиком. Только знай сразу, что бомбить можно будет лишь захваченные инопланетными ящерами города.",
